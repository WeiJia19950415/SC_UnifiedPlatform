...
public class SC_UnifiedPlatformDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SC_UnifiedPlatformDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
